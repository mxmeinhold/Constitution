...
Each Introductory Process participant, after the first week, is given two (2) weeks to return a document that should contain a signature from all Active Resident Members, all Introductory Resident Members, each Executive Board Member, and fifteen (15) of any combination of the following:
\begin{itemize}
